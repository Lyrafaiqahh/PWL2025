...
{
    $barang = BarangModel::with('kategori')->find($id); // ubah relasi jika perlu
    ...
    $activeMenu = 'barang'; // ubah menu aktif jadi barang
...
public function edit(string $id)
{
    ...
    $kategori = KategoriModel::all(); // ganti sesuai relasi jika ada
    ...
    public function create()
{
    ...
    $activeMenu = 'barang'; // sesuaikan dengan menu barang
    $kategori = KategoriModel::all(); // jika ada relasi kategori, ambil di sini
    ...
    return view('barang.create', [
        ...
        'page' => $page,
        'activeMenu' => $activeMenu,
        'kategori' => $kategori, // optional jika diperlukan di form
